...
const ProcessorInfo TemporalTreeGenerateFromCSV::getProcessorInfo() const { return processorInfo_; }

TemporalTreeGenerateFromCSV::TemporalTreeGenerateFromCSV()
    : Processor(), inHierarchy("inHierarchy"), inDataValues("inData"), outTree("outTree") {
    addPort(inHierarchy);
