...
/** \class TemporalTreeJSONReaderCBOR
    ...
    @author Tino Weinkauf and Wiebke Köpp
*/
class IVW_MODULE_TEMPORALTREEMAPS_API TemporalTreeJSONReaderCBOR
    : public DataReaderType<TemporalTree> {
    // Friends
    // Types
public:
    // Construction / Deconstruction
...
/** \class TemporalTreeJSONReaderMsgPack
    ...
    @author Tino Weinkauf and Wiebke Köpp
*/
class IVW_MODULE_TEMPORALTREEMAPS_API TemporalTreeJSONReaderMsgPack
    : public DataReaderType<TemporalTree> {
    // Friends
    // Types
public:
...
/** \class TemporalTreeJSONReaderNTG
    ...
    @author Tino Weinkauf and Wiebke Köpp
*/
class IVW_MODULE_TEMPORALTREEMAPS_API TemporalTreeJSONReaderNTG
    : public DataReaderType<TemporalTree> {
    // Friends
    // Types
public:
